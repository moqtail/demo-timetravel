...
function checkBrowserCompatibility() {
  ...
  try {
    ...
    if (!('VideoEncoder' in window) || !('VideoDecoder' in window)) {
      ...
      missingDetails.push({ api: 'WebCodecs (Critical)' })
    }
...
export default function JoinPage() {
  ...
  useEffect(() => {
    try {
      ...
      if (criticalMissing.length > 0) {
        ...
        setCompatibilityError(
          'MediaStreamTrackProcessor is not available. You can join the session but video publishing will be disabled.',
        )
        setCompatibilityDetails(missingDetails)
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    if (hasCriticalMissing) {
      ...
      window.open('https://github.com/moqtail/demo-timetravel/wiki/Troubleshooting-Guide', '_blank')
  ...
  return (
    <div className="join-container">
      ...
      <div className="join-content">
        ...
        <h1>
          <b>Time Travel in MOQ Conferencing</b>
        </h1>
        {compatibilityError && (
