...
import { telemetryDB } from '@/util/telemetryDB'
      ...
      {mediaStreamTrackProcessorMissing && (
        <div className="bg-yellow-900 border-l-4 border-yellow-500 px-6 py-3 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <p className="text-yellow-200 font-medium">Video Publishing Disabled</p>
              <p className="text-yellow-300 text-sm">
                MediaStreamTrackProcessor is not available in your browser. Publishing (sending) your video to other
                participants will not work.
              </p>
            </div>
          </div>
          <a
            href="https://github.com/moqtail/demo-timetravel/wiki/Troubleshooting-Guide"
            target="_blank"
